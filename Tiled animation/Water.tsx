...
<tileset name="Water" tilewidth="32" tileheight="32">
 ...
 <tile id="120">
  <properties>
   <property name="animation-delay0" value="AAAA"/>
   <property name="animation-delay1" value="BBBB"/>
   <property name="animation-delay2" value="CCCC"/>
   <property name="animation-delay3" value="DDDD"/>
   <property name="animation-delay4" value="EEEE"/>
   <property name="animation-delay5" value="FFFF"/>
   <property name="animation-delay6" value="GGGG"/>
   <property name="animation-delay7" value="HHHH"/>
   <property name="animation-delay8" value="IIII"/>
